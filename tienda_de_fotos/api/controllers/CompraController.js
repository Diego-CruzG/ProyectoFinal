...
module.exports = {
    ...
    carroCompra: async (peticion, respuesta) => {
        ...
        if (!peticion.session || !peticion.session.cliente) {
            ...
            //SE CONSULTAN TODAS LAS FOTOS PARA ESE CLIENTE, POPULATE TRAE INFORMACION ADICIONAL DE CADA FOTO
    ...
    ordeDeCompra: async (peticion, respuesta) => {
    ...
    agregarListaDeseo: async (peticion, respuesta) => {
        ...
        if (foto) {
            ...
            peticion.addFlash('mensaje', 'La foto ya ha sido agregada a la lista de deseos')
        } else {
            ...
            peticion.session.listaDeseo = await ListaDeseo.find({ cliente: peticion.session.cliente.id })
            peticion.addFlash('mensaje', 'Foto agregada a la lista de deseos')
        }
